...
$(BUILD_DIR)/kernel.wasm: $(SOURCE_DIR)/kernel.c $(SOURCE_DIR)/graphics.c $(SOURCE_DIR)/text.c
	emcc $(CFLAGS) -s EXPORTED_FUNCTIONS="['_main', '_irq_handler', '_get_memory_map']" $(SOURCE_DIR)/kernel.c $(SOURCE_DIR)/graphics.c $(SOURCE_DIR)/text.c -o $(BUILD_DIR)/kernel.wasm
